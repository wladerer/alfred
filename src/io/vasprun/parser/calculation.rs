...
use super::super::error::{Result, VasprunError};
use super::super::types::{IonicStep, ScfEnergy, Eigenvalues, Projected, Dos, Dielectric};
...
pub fn parse_calculation(
    ...
    let mut structure: Option<super::super::types::Structure> = None;
